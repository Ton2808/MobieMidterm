...
public class IntroActivity extends AppCompatActivity {
    ...
    private void recyclerViewPopular(){
        ...
        foodList.add(new BookDomain("Đại Gia Gatsby", "great_gatsby", "\"Gatsby đã tin vào đốm sáng xanh ấy, vào cái tương lai mê đắm đến cực điểm đang rời xa trước mắt chúng ta năm này qua năm khác. Ừ thì nó đã tuột khỏi tay chúng ta, nhưng có làm sao đâu – ngày mai chúng ta sẽ lại chạy nhanh hơn, vươn tay ra xa hơn…”\n" +
                "\n" +
        ...
        foodList.add(new BookDomain("Cây Cam Ngọt Của Tôi", "caycamngot", "Hãy làm quen với Zezé, cậu bé tinh nghịch siêu hạng đồng thời cũng đáng yêu bậc nhất, với ước mơ lớn lên trở thành nhà thơ cổ thắt nơ bướm. Chẳng phải ai cũng công nhận khoản “đáng yêu” kia đâu nhé. Bởi vì, ở cái xóm ngoại ô nghèo ấy, nỗi khắc khổ bủa vây đã che mờ mắt người ta trước trái tim thiện lương cùng trí tưởng tượng tuyệt vời của cậu bé con năm tuổi.\n" +
                "\n" +
    ...
    private void recyclerNewestPopular(){
        ...
        ArrayList<BookDomain> foodList = new ArrayList<>();
        foodList.add(new BookDomain("Nhà Giả Kim", "nhagiakim", "Tất cả những trải nghiệm trong chuyến phiêu du theo đuổi vận mệnh của mình đã giúp Santiago thấu hiểu được ý nghĩa sâu xa nhất của hạnh phúc, hòa hợp với vũ trụ và con người.\n" +
                "\n" +
        ...
        foodList.add(new BookDomain("Dám Bị Ghét", "dambighet", "TẠI SAO BẠN CỨ PHẢI SỐNG THEO KHUÔN MẪU NGƯỜI KHÁC ĐẶT RA?\n" +
                "\n" +
