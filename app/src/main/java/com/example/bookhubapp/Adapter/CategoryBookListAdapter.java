...
public class CategoryBookListAdapter extends RecyclerView.Adapter<CategoryBookListAdapter.ViewHolder> {
    ArrayList<BookDomain> popularBook;

    public CategoryBookListAdapter(ArrayList<BookDomain> bookDomains){
        this.popularBook = bookDomains;
    }

    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_cart_category, parent, false);
        return new ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull CategoryBookListAdapter.ViewHolder holder,int position) {
